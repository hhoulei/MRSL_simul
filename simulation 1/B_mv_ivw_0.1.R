...
for(tt in 1:length(elowb)){
  ...
  write.csv(result_once1,paste0('B_elow_',elow,'_eup_',eup,'method_',1,'_0.1.csv'))
  ...
  write.csv(result_once2,paste0('B_elow_',elow,'_eup_',eup,'method_',2,'_0.1.csv'))
  ...
  write.csv(result_once3,paste0('B_elow_',elow,'_eup_',eup,'method_',3,'_0.1.csv'))
  ...
  write.csv(result_once4,paste0('B_elow_',elow,'_eup_',eup,'method_',4,'_0.1.csv'))
  ...
  write.csv(result_once5,paste0('B_elow_',elow,'_eup_',eup,'method_',5,'_0.1.csv'))
  ...
  write.csv(result_once6,paste0('B_elow_',elow,'_eup_',eup,'method_',6,'_0.1.csv'))
  ...
  write.csv(result_once7,paste0('B_elow_',elow,'_eup_',eup,'method_',7,'_0.1.csv'))
...
write.csv(result,'B_mv_ivw_0.1.csv')

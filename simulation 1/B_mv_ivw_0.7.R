...
Datageneration <- function(N,g,elow,eup,method,b){
  ...
  if(method==1){
    ...
    M2 <- runif(1,elow,eup)*X + GX %*% rnorm(gx,0,0.2^2) + U + rnorm(N,0,1)
    ...
    M2 <- runif(1,elow,eup)*X + G %*% runif(g,0.05,0.2) + U + rnorm(N,0,1)
    Y <- b*X + runif(1,elow,eup)*M2 + U + rnorm(N,0,1)
    ...
    U <- rnorm(N,0,1)
    X <- GX %*% runif(gx,0.05,0.2) + U + rnorm(N,0,1)
    M2 <- runif(1,elow,eup)*X + 
      G2 %*% runif(g2,0.05,0.2) + U + rnorm(N,0,1)
    Y <- b*X + runif(1,elow,eup)*M2 + U + rnorm(N,0,1)
    G <- cbind(GX,G2)
    ...
    M2 <- runif(1,elow,eup)*X + GX %*% runif(gx,0.05,0.2) + 
      G2 %*% runif(g2,0.05,0.2) + U + rnorm(N,0,1)
    Y <- b*X + runif(1,elow,eup)*M2 + U + rnorm(N,0,1)
    G <- cbind(GX,G2)
    ...
    U <- rnorm(N,0,1)
    X <- G2 %*% runif(g2,0.05,0.2) + G3 %*% runif(g3,0.05,0.2) + 
      U + rnorm(N,0,1)
    M2 <- runif(1,elow,eup)*X + GX %*% runif(gx,0.05,0.2) + 
      G2 %*% runif(g2,0.05,0.2) + U + rnorm(N,0,1)
    Y <- b*X + runif(1,elow,eup)*M2 + U + rnorm(N,0,1)
...
for(tt in 1:length(elowb)){
  ...
  write.csv(result_once1,paste0('B_elow_',elow,'_eup_',eup,'method_',1,'_0.7.csv'))
  ...
  write.csv(result_once2,paste0('B_elow_',elow,'_eup_',eup,'method_',2,'_0.7.csv'))
  ...
  write.csv(result_once3,paste0('B_elow_',elow,'_eup_',eup,'method_',3,'_0.7.csv'))
  ...
  write.csv(result_once4,paste0('B_elow_',elow,'_eup_',eup,'method_',4,'_0.7.csv'))
  ...
  write.csv(result_once5,paste0('B_elow_',elow,'_eup_',eup,'method_',5,'_0.7.csv'))
  ...
  write.csv(result_once6,paste0('B_elow_',elow,'_eup_',eup,'method_',6,'_0.7.csv'))
  ...
  write.csv(result_once7,paste0('B_elow_',elow,'_eup_',eup,'method_',7,'_0.7.csv'))
...
write.csv(result,'B_mv_ivw_0.7.csv')

...
source("Algorithm_new_binary.R")
source("MRSL.R")

library(MRPRESSO)
library(MendelianRandomization)

Comp <- function(x,N,each_g,gl,gu,dlB,duB,D_beta){
  
  fdata <- DataGeneration_magic(N,each_g,gl,gu,dlB,duB,D_beta)
  R <- fdata$D_beta
  ...
  # ret <- list(res11=res11,res12=res12,res13=res13,
  #             res14=res14,res15=res15,res16=res16,
  #             res2=res2,res3=res3,res21=res21,res31=res31,
  #             #res4=res4,
  #             #r2=rr,Fsta=ff,
  #             time11=time11, time12=time12, time13=time13,
  #             time14=time14, time15=time15, time16=time16,
  #             time2=time2,time3=time3,time21=time21,time31=time31)
  return(ret)
